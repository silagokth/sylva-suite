...
int main(int argc, char *argv[]) {
    ...
    cJSON_ArrayForEach(item, global_line) {
        ...
        if (address >= base_address && address <= base_address + args.token) {
            snprintf(str_num, sizeof(str_num), "%d", input_values[address - base_address]);
